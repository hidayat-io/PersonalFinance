 ...
 */
public class FragmentCategoryOut extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup view1 = (ViewGroup) inflater.inflate(R.layout.fragment_cat_pengeluaran, null);
    ...
    private void prepareCategory(){
        ...
        param = " tipe_trans='o' AND id_kat != '10' "; //10 is simpanan
